...
# Build test command
TEST_CMD="dotnet test \"$SOLUTION_ROOT\" --collect:\"Code Coverage\" --settings:\"$SOLUTION_ROOT/Rtl.Core.runsettings\" --results-directory:\"$TEST_RESULTS_DIR\""
...
dotnet reportgenerator \
    ...
    "-title:Rtl.Core Coverage Report"
