# Claude-Powered Modular Monolith Template

A production-ready .NET 10 modular monolith with DDD, Clean Architecture, and CQRS.
...
```bash
dotnet run --project src/Api/Host   # API at https://localhost:5001
