...
<ProjectReference Include="..\..\Common\Rtl.Core.Common.Domain\..." />
...
dotnet sln Rtl.Core.Api.sln remove src/Modules/{Module}/**/*.csproj
dotnet sln Rtl.Core.Api.sln remove src/Api/Host.{Module}/*.csproj
