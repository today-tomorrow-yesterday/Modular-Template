...
3. Set Action to **Start** for:
   - `ModularTemplate.Api.SampleOrders`
   - `ModularTemplate.Api.SampleSales`
...
dotnet user-secrets init --project src/Api/Host

# Set secrets
dotnet user-secrets set "ConnectionStrings:Database" "Host=localhost;..." --project src/Api/Host
```
  ...
  "configurations": [
    {
      ...
      "type": "coreclr",
      "request": "launch",
      "program": "${workspaceFolder}/src/Api/Host/bin/Debug/net10.0/ModularTemplate.Api.dll",
    ...
    },
    {
      ...
      "type": "coreclr",
      "request": "launch",
      "program": "${workspaceFolder}/src/Api/Host.SampleOrders/bin/Debug/net10.0/ModularTemplate.Api.SampleOrders.dll",
...
```bash
dotnet watch run --project src/Api/Host
```
