...
namespace Modules.Sales.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260327134458_AddProductRemovedAndCacheSoftDelete")]
    partial class AddProductRemovedAndCacheSoftDelete
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Modules.Sales.Domain.CustomersCache.CustomerCache", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("PrimarySalesPersonFederatedId")
                        .HasDatabaseName("ix_customers_primary_sp_federated_id");

                    b.HasIndex("RefPublicId")
                        .IsUnique()
                        .HasDatabaseName("uq_customers_ref_public_id");

                    b.ToTable("customers", "cache");
                });
            ...
            modelBuilder.Entity("Modules.Sales.Domain.InventoryCache.LandParcelCache", b =>
                {
                    ...
                    b.Property<bool>("IsRemovedFromInventory")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
            ...
            modelBuilder.Entity("Modules.Sales.Domain.Packages.PackageLine", b =>
                {
                    ...
                    b.Property<bool>("IsProductRemovedFromInventory")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
            ...
            modelBuilder.Entity("Modules.Sales.Domain.Sales.Sale", b =>
                {
                    b.HasOne("Modules.Sales.Domain.CustomersCache.CustomerCache", "Customer")
                        .WithMany()
