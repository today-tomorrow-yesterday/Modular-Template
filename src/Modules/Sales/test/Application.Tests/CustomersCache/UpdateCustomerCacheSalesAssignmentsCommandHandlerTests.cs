...
public sealed class UpdateCustomerCacheSalesAssignmentsCommandHandlerTests
{
    ...
    private readonly UpdateCustomerCacheSalesAssignmentsCommandHandler _sut;

    public UpdateCustomerCacheSalesAssignmentsCommandHandlerTests()
    {
        ...
        _sut = new UpdateCustomerCacheSalesAssignmentsCommandHandler(_cacheWriteScope, _customerCacheWriter, _dateTimeProvider);
    }
    ...
    public async Task Returns_success_and_updates_sales_assignments()
    {
        ...
        var command = new UpdateCustomerCacheSalesAssignmentsCommand(
        ...
        await _customerCacheWriter.Received(1).UpdateSalesAssignmentsAsync(
