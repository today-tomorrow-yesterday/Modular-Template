...
// Base class for Sales module endpoint tests.
//
// Handles:
...
public abstract class SalesEndpointTestBase(SalesEndpointTestFixture fixture) : IAsyncLifetime
{
    protected static readonly Faker Faker = new();

    protected readonly SalesEndpointTestFixture Fixture = fixture;
    protected readonly HttpClient Client = fixture.CreateClient();

    protected Guid TestCustomerId => Fixture.TestCustomerId;
    protected int TestHomeCenterNumber => SalesEndpointTestFixture.TestHomeCenterNumber;
