        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    co_buyer_customer_id = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("pk_customers", x => x.id);
                    table.ForeignKey(
                        name: "fk_customers_customers_co_buyer_customer_id",
                        column: x => x.co_buyer_customer_id,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_contact_points_customers_customer_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_customer_identifiers_customers_customer_id",
                        column: x => x.customer_id,
                        principalSchema: "customers",
                        principalTable: "customers",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_sales_assignments_customers_customer_id",
                        column: x => x.customer_id,
                        principalSchema: "customers",
                        principalTable: "customers",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_contact_points_customer_id_type",
                schema: "customers",
                table: "contact_points",
                columns: new[] { "customer_id", "type" });

            migrationBuilder.CreateIndex(
                name: "ix_customer_identifiers_type_value",
                schema: "customers",
                table: "customer_identifiers",
                columns: new[] { "type", "value" });

            migrationBuilder.CreateIndex(
                name: "uq_customer_identifiers_customer_id_type",
                schema: "customers",
                table: "customer_identifiers",
                columns: new[] { "customer_id", "type" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "ix_customers_co_buyer_customer_id",
                schema: "customers",
                table: "customers",
                column: "co_buyer_customer_id");

            migrationBuilder.CreateIndex(
                name: "ix_customers_home_center_number",
                schema: "customers",
                table: "customers",
                column: "home_center_number");

            migrationBuilder.CreateIndex(
                name: "ix_customers_lifecycle_stage",
                schema: "customers",
                table: "customers",
                column: "lifecycle_stage");

            migrationBuilder.CreateIndex(
                name: "uq_customers_public_id",
                schema: "customers",
                table: "customers",
                column: "public_id",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "ix_sales_assignments_customer_id",
                schema: "customers",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_sales_assignments_customer_id_sales_person_id",
                schema: "customers",
                table: "sales_assignments",
                columns: new[] { "customer_id", "sales_person_id" },
                unique: true);
