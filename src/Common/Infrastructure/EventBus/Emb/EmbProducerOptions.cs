...
public sealed class EmbProducerOptions : IValidatableObject
{
    ...
    /// <summary>
    /// The name of the EventBridge bus to publish to (e.g., "dev-mt-internal-event-bridge").
    /// </summary>
    [Required]
    public string EventBus { get; set; } = string.Empty;

    /// <summary>
    /// Cost center identifier used by the EMB producer (e.g., "mt").
    /// </summary>
    [Required]
    public string CostCenter { get; set; } = string.Empty;

    /// <summary>
    /// The event source identifier sent with each EventBridge event (e.g., "mt").
    /// </summary>
    [Required]
    public string EventSource { get; set; } = string.Empty;

    /// <summary>
    /// Reporter identifier included in EMB message metadata (e.g., "mt.core").
    /// </summary>
    [Required]
