...
{
    // Pricing
    Task<WheelAndAxlePriceResult> GetWheelAndAxlePriceByStock(WheelAndAxlePriceByStockRequest request, CancellationToken ct);
    Task<WheelAndAxlePriceResult> CalculateWheelAndAxlePriceByCount(WheelAndAxlePriceByCountRequest request, CancellationToken ct);
