...
var moduleEndpoints = new SampleSalesModuleEndpoints();
...
builder.Services.AddCommonApplication([SampleApplication.Assembly]);
...
// SampleSales module services
builder.Services.AddSampleSalesModule(
    builder.Configuration,
    builder.Environment,
    databaseConnectionString);
...
app.ApplyMigrations<SampleDbContext>(builder.Environment, databaseConnectionString);
